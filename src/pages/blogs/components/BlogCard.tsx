        ...
        <div className={styles.blogCard}>
            ...
            <div className={styles.blogDetails}>
                ...
                <div className={styles.blogMeta}>
                    <span className={styles.blogIcon}><CalendarDays /> {blog.publicationDate}</span>
                    <span className={styles.blogIcon}><Star />{blog.rating} (127 reviews)</span>
                    <span className={styles.blogIcon}><MessageCircleMore /> {blog.numComments} Comments</span>
